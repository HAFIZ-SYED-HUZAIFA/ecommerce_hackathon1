  ...
  return (
    <div>
      ...
      {productData.map((product, index) => (
        <div key={index} className='w-[269px] h-[345px] flex flex-col items-center justify-center transform transition-transform duration-300 hover:scale-105'>
          {/* top section */}
          ...
          <div className="flex items-center justify-center opacity-0 hover:opacity-100 duration-200 mt-[220px]">
      ...
      <div className='flex items-center justify-center mt-28 below-600:mt-14'>
        ...
        0ur Newslater</p>
        <Link href="/shops/grid"><button className='w-[173px] h-[49px] bg-[#FB2E86] text-center text-[#FFFFFF] text-[17px] font-josefin tracking-[2%] below-1200:mb-5 below-600:w-[100px] below-600:h-[30px] below-600:text-[12px] below-600:mb-5'> Shop Now</button></Link>
        </div>
      </div>

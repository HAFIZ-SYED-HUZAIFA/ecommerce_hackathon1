  ...
  return (
    <div>
      ...
      <div className='mt-16'>
        ...
        <div key={index} className='w-[270px] h-[320px] flex gap-4 flex-col items-center justify-center shadow-[0px_8px_40px_rgba(49,32,138,0.05)] transform transition-transform duration-300 hover:scale-105'>
